...
%Then the matched filtering amplitude can be calculated by segmenting the intergral into contribution
...
\subsection{Calculating the mismatch}
Writing the parameter space offsets in terms of the total spindown variation
\begin{align}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.5\textwidth]{mismatch_during_one_segment}
