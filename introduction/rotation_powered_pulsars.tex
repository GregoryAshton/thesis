...
braking for a given pulsar. Specifically, differentiating Eqn.~\eqref{eqn: power law spindown}
...
To infer the age of the pulsar, Eqn.~\eqref{eqn: power law spindown} can
...
\begin{align}
k = \frac{B_0 R^{6} \sin^{2}\alpha}{6c^{3}I_0}.
\end{align}
Then rearranging and substituting for $k$ in Eqn.~\eqref{eqn: power law
spindown} we can estimate the surface magnetic field strength by
\begin{equation}
