...
\input{\IntroductionDir/pulsar_timing_methods}

\section{Glitches}
\label{ref: glitches}
\input{\IntroductionDir/glitches}

\section{Timing noise: observations}
\label{sec: timing noise observations}
\input{\IntroductionDir/timing_noise}

\section{Timing noise: interpretations}
\label{sec: timing noise interpretations}
\input{\IntroductionDir/timing_noise_interpretations}
