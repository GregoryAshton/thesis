...
The method used to calculate the spindown in Fig.~\ref{fig: lyne 2010 fig 2}
...
\begin{figure}[htb]
    ...
    \caption{A deterministic realisation of the Lyne switched spindown model. The
             resulting structure in the time-averaged spindown rate and the phase
...
\citep{Hobbs2010}.  To develop this, \citet{Lyne2010} added a probabilitisc
...
The spindown rates seen in Figs.~\ref{fig: lyne example D=0} and Fig.~\ref{fig:
...
the spindown rates of B1828-11 seen in Fig.~\ref{fig: lyne 2010 fig2}.
With only the ingredients described by \citet{Lyne2010}, it is not possible
to consistently replicate the double peaked spindown rate variations seen
...
If the double peaked spindown rates of B1828-11, B0919+06, or any other pulsar
