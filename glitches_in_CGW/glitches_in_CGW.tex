...
radio pulsar population using the glitch-database maintained by
\citet{Espinoza2011} and available at
\url{www.jb.man.ac.uk/pulsar/glitches.html}.  Our goal is to make a statement
about how often glitches occur and their magnitudes for the types of neutron
stars which may be emitting GWs in the parameter space of typical GW searches.
This task is made difficult since many searches look for young, rapidly
rotating stars for which we only have a small sample of observations. Therefore,
we must moderately extrapolate to apply our results to the
...
discussion). The glitch catalogue \citep{Espinoza2011} reports 472 events from
...
$R$ is 0 and 1. Furthermore, it was verified that when the magnitude of the glitch
