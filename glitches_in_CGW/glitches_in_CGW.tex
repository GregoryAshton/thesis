...
in which a neutron star is believed to exist (e.g. the \citet{ligo_SNR2015} search
...
parameter space searched by the S5R5 E@H search. Finally, dashed lines mark isoclines
...
%The S5R5 E@H search space spans all observed spin-down rates; however, the discretisation
...
S5R5 E@H search parameters. We have similarly
...
spin-down rate used in the S5R5 E@H search.}
...
range of $\nudotS$ values considered in the S5R5 E@H search. We also multiply this
...
$\nudotS$ over the range of values used in the S5R5 E@H search. On the right axis is
...
\end{split}
\end{align}
These values are less than the coherence time used in the S5R5 E@H search, which
...
semi-coherent searches, it is in fact bounded by the minimmum of $R$ and $1-R$;
...
can therefore be intepretted by realising that if the metric-mismatch is greater than
1, there will be large true mismatch.
...
dashed lines have been added to indicate the probability of one or more normal
