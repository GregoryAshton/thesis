...
furthermore, as we found in Sec.~\ref{sec: spin-down rate numerical}, to explain
...
dotted curve in Fig.~\ref{fig: perera illustration}.  Clearly, the
...
numerically in Sec.~\ref{sec: spin-down rate numerical}. This derivation uses a
...
shaped; see their Fig.~5 for a schematic illustration.   The authors of
...
In Fig.~ \ref{fig: modified-gaussian beam-width recreate geometry} we pick
