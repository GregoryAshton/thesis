...
was investigated by \citet{Akgun2006} who demonstrated how a `patchy' emmission
region could produce such observations under a pure precession hypothesis.
Alternatively, precession could in fact be the clock biasing the switching as
in the hybrid model of \citet{Jones2012}.
For the switching model, this
...
investigation. In the future, we would like to include these data sets and see how
