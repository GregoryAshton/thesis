...
free precession} we introduced free precession, the most general motion for a
...
conclude that the precession is not persistent.
...
\tabcolsep=0.11cm
	\begin{tabular}[h]{|l|c|c|c|c|c|}\hline
		&  $\epsI$  & $\epsA $ & 	$B_{0} \; $[Gauss] & $\tauS$ [s] & $ \tauP$  [s] \\ \hline
	Neutron star A 	&  $  1.0{\times} 10^{-9}  $  & $  0.5{\times} 10^{-10}  $ & 	$  1.3{\times} 10^{13}  $   & $  3.6{\times} 10^{8}  $ & $  6.3{\times} 10^{5}  $\\
	Neutron star B 	&  $  0.4{\times} 10^{-10}  $  & $  0.5{\times} 10^{-10}  $ & 	$  1.3{\times} 10^{13}  $   & $  3.6{\times} 10^{8}  $ & $  1.6{\times} 10^{7}  $\\
	Neutron star C 	&  $  1.0{\times} 10^{-15}  $  & $  0.5{\times} 10^{-10}  $ & 	$  1.3{\times} 10^{13}  $   & $  3.6{\times} 10^{8}  $ & $  6.3{\times} 10^{11}  $\\ \hline
	\end{tabular}
}
...
the polar angle $a'$ and azimuthal angle $\phi'$ are constant, we argue
...
since it amounts to nothing more than a small shift in the axes about which
that spin-vector precesses. For this reason, the solutions found by
