...
\caption{Table of relevant values for the selected points. In calculating the
    ...
    $R=1\times10^{6}$~cm for the radius, the initial value
    of the spin frequency, $\omega_{0} = 1\times10^{4}$ rads/s and the initial
    value of $a_0=50^{\circ}$.}
...
\subsubsection{Neutron star A in region \texorpdfstring{$\tauS>\tauA>\tauP$}{}}
\label{sec: A}
