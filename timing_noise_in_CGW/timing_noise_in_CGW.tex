...
In Fig.~\ref{fig: narrow-band example} we show the mismatch as a function of
...
\caption{In Fig.~(a) we show the mismatch as a function of parameter space
    ...
    a minimum at this point. This can be compared with Fig.~(b) showing the
