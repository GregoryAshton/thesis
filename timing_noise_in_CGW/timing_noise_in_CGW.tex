...
a month is short enough such that these coefficients and Eqn.~\eqref{eqn:
Taylor} track the rotational phase during the month. The Crab ephemeris tracks
...
expansion \eqref{eqn: Taylor} and typical values of $\dddot{\nu} \sim 10^{-30}$
...
models for which, as shown in Sec.~\ref{sec: TN intepretations random walk
