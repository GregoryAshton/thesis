...
$\rho^{2} \propto \Tcoh$ (e.g.\ see~\citep{Prix2009}) where $\Tcoh$ is the
coherent observation time. This suggests searching
...
year.  For gravitational-wave searches, this level of
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.75\textwidth]{PhaseJump}
