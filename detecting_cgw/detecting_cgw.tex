...
approximation for semi-coherent searches}. In this section we
will develop a general formalism for a signal described by an arbitrary number
of sub-domains; this will be used in Sec.~\ref{sec: glitches in cgw} to calculate the
mismatch due to glitches and in Sec.~\ref{sec: timing noise in cgw analytic}
to calculate the mismatch due to a random walk model of timing noise.
...
If instead we set the reference time to be at the start of each segment then,
