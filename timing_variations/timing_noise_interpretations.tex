...
gradient of the reduction in frequency is increased: the spin-down rate is faster.
It is thought that measurements of the frequency in the off state
...
panel (\textbf{B}). This shows significant quasi-periodic modulations correlated
...
method used to do this see Sec.~\ref{sec: switching}) over a $\sim20$~year
